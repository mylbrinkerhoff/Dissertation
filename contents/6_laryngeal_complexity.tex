...
From the SoE measure, we see that the strength of voicing is not drastically different between modal and non-modal phonation. This suggests that the non-modal phonations are not as strongly articulated in SLZ when compared to non-modal phonation in other languages \citep[e.g.,][]{garellekVoicingGlottalConsonants2021,garellekMarginsPhonologyPhonetics2025,wellerInteractionsToneGlottalization2023,wellerLexicalToneVowel2023,wellerVoiceQualityTone2024}
