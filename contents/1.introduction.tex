...
\begin{table}[!h]
    \centering
    \caption{Language types based on the lexically contrastive nature of \textit{f0}/tone/pitch accents (rows) and voice quality on vowels (columns) and their interactions \citep{espositoCrossLinguisticPatterns2020}}
