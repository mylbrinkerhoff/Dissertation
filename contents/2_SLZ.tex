...
\ea \label{ex:SLZphonation} Four-way near minimal phonation contrast
    \ea \textit{yag}   [çax˨] `tree; wood; almúd (unit of measurement  $\thicksim$4kg)'
