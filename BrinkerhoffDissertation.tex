...
\include{contents/0_1_abstract}
\include{contents/0_2_dedication}
\include{contents/0_3_acknowledgements}

\end{frontmatter}

\include{contents/1_introduction}
\include{contents/2_SLZ}
\include{contents/3_residual_H1}
\include{contents/4_acoustic_landscape}
\include{contents/5_tree_modaling}
\include{contents/6_laryngeal_complexity}
\include{contents/7_modeling_lc}
\include{contents/8_conclusion}

%--------------------------------------------------------------------------
%  Bibliography
%--------------------------------------------------------------------------
\include{contents/bib.tex}
